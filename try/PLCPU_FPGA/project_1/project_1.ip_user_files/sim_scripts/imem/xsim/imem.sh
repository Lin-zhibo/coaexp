...
#
# Script generated by Vivado on Thu May 22 22:35:20 +0800 2025
...
#
# Usage        : imem.sh
#                imem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                imem.sh [-reset_run]
#                imem.sh [-reset_log]
#                imem.sh [-help]
#
...
# script info
echo -e "imem.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./imem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot imem xil_defaultlib.imem xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/software/vivado_ML/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb imem.wdb xsim.dir libdpi.so)
...
Usage: imem.sh [-reset_log]\n\
Usage: imem.sh [-keep_index]\n\

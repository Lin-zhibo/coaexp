...
design_libs_elab="-libname dist_mem_gen_v8_0_12 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver dist_mem_gen_v8_0_12 xil_defaultlib)
...
compile()
{
  xmvlog -work dist_mem_gen_v8_0_12 $xmvlog_opts \
